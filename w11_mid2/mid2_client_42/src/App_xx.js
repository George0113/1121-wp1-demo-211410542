...
import MenuNodePage_42 from './pages/mid2_42/MenuNodePage_42';
import MenuByCategoryNodePage_42 from'./pages/mid2_42/MenuByCategoryNodePage_42';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/mid2_node_42' element={<MenuNodePage_42 />} />
        <Route path='/mid2_cat_node_42' element={<MenuByCategoryNodePage_42 />} />
